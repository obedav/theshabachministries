...
function FutureGospelGatherings() {
      ...
      <div className="prayer-request-section">
        <div className="prayer-content">
          ...
          <div className="involvement-options">
            <Link to="/prayer-team" className="involvement-btn">
              Join Prayer Team
            </Link>
            <Link to="/ministry-support" className="involvement-btn">
              Support The Vision
            </Link>
          </div>
        </div>
      ...
      <div className="contact-pastor-section">
        <div className="pastor-card">
          <div className="pastor-image">
            <img src="/assets/images/team/worship-pastor.jpg" alt="Worship Pastor" />
          </div>
...
export default FutureGospelGatherings;